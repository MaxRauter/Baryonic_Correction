...
GROUP_PATH = "/Users/Maxi/Desktop/Uni/Master/Masterarbeit/Baryonic_Correction/Baryonic_Correction/tests/Data/groups_014_dm.hdf5"
SNAPSHOT_PATH = "/Users/Maxi/Desktop/Uni/Master/Masterarbeit/Baryonic_Correction/Baryonic_Correction/tests/Data/snapshot_014_dm.hdf5"
...
def test_init_with_paths():
    ...
    reader = sim.CAMELSReader(path_group=GROUP_PATH, 
                            path_snapshot=SNAPSHOT_PATH,
                            index=5, 
                            verbose=True)
    assert reader.path_group == GROUP_PATH
    assert reader.path_snapshot == SNAPSHOT_PATH
...
def test_load_halodata_file_not_exists():
    ...
    reader = sim.CAMELSReader(path_group="Baryonic_Correction/BCM/tests/Data/groups_01875_dm.hdf5", 
                            path_snapshot="Baryonic_Correction/BCM/tests/Data/snapshot_08815_dm.hdf5",
                            index=5, 
                            verbose=True)
